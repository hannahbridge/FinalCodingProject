...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		pmt = PMT(this.getdAnnualReturnWorking() / 12, this.getiYearsToWork() * 12.0, 0.0, this.TotalAmountToSave(), false);
	...
	public double TotalAmountToSave() {
		...
		double pv = 0;
		pv = PV(this.getdAnnualReturnRetired() / 12, this.getiYearsRetired() * 12.0, this.getdRequiredIncome() - this.getdMonthlySSI(), 0, false); 
